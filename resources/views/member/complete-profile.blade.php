                        ...
                        @endif
                            ...
                            @elseif ($number === 4)
                                <div class="wizard-form-stack">
                                        ...
                                        <div class="inline-checkbox-option" data-whatsapp-sync-wrapper>
                                            <div class="inline-checkbox-control">
                                                <input
                                                    type="checkbox"
                                                    value="1"
                                                    aria-label="Use primary mobile number for WhatsApp"
                                    ...
                                    <div class="wizard-field">
                                        <span>Email Address</span>
                                        <input type="email" name="email_address" value="{{ old('email_address', $profile?->email_address ?? $user->email) }}" placeholder="Enter your email address" aria-label="Email address" readonly>
                                        @error('email_address') <small>{{ $message }}</small> @enderror
                                    </div>
                                    <div class="wizard-field label-wide">
                                        <span>Present Address</span>
                                        <textarea name="present_address" rows="4" placeholder="Enter your present address" aria-label="Present address">{{ old('present_address', $profile?->present_address) }}</textarea>
                                        @error('present_address') <small>{{ $message }}</small> @enderror
                                    </div>
                                    <div class="wizard-field label-wide">
                                        <span>Permanent Address</span>
                                        <textarea name="permanent_address" rows="4" placeholder="Enter your permanent address" aria-label="Permanent address">{{ old('permanent_address', $profile?->permanent_address) }}</textarea>
                                    ...
                                    <div class="wizard-field">
                                        ...
                                        <select name="city_district" aria-label="City or district">
                                    ...
                                    <div class="wizard-field">
                                        ...
                                        <input type="text" name="postal_code" value="{{ old('postal_code', $profile?->postal_code) }}" placeholder="Enter your postal code" aria-label="Postal code">
                            ...
                            <div class="action-row wizard-nav-actions wizard-auth-actions">
                                ...
                                @elseif ($number === 10)
                                    <button class="button button-primary wizard-auth-submit" type="submit" name="submit_for_verification" value="1">Submit for Review</button>
                                @endif
                            </div>
                    </section>
                @endforeach
